                      ...
                      >
                        ...
                        <div className="p-6">
                          <div className="flex justify-between items-start mb-3">
                            <h4 className="uppercase text-gray-900 transition-colors duration-300">
                              {item.title}
                            </h4>
                          </div>
            ...
            <ScrollTrigger animationType="slide-left" threshold={0.2}>
              ...
              >
                ...
                <form className="space-y-4">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-primary text-white py-3 rounded-lg hover:bg-secondary transition-all duration-300 font-semibold cursor-pointer"
                  >
                    Request Reservation
                  </button>
                </form>
