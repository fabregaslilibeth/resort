...
const CancellationPolicy: React.FC = () => {
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-8 text-sm">
      ...
      {/* LLV Rain Guarantee */}
      <div className="space-y-4 bg-gray-50 p-6 rounded-lg">
        <h3 className="font-semibold text-gray-900">5. LLV Rain Guarantee</h3>
        <p className="text-gray-900 mb-4 italic">&ldquo;In everyone&apos;s life, a little rain must fall. But not too much when you are on vacation!&rdquo;</p>
        <p className="text-gray-900 mb-4">Introducing the <strong>LLV Rain Guarantee</strong>:</p>
