    ...
    <footer className="bg-[#2C2C2C] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          {/* CONTACT US Section */}
          <div>
            <h3 className="text-orange-400 font-bold text-lg mb-4">CONTACT US</h3>
          ...
          {/* Payment Section */}
          <div>
            <h3 className="text-orange-400 font-bold text-lg mb-4">WE ACCEPT</h3>
            <div className="p-4 rounded">
              <div className="grid grid-cols-2 gap-3">
                {paymentOptions.map((option, index) => (
                  <div key={index} className="h-12 w-full bg-transparent rounded-md p-2 flex items-center justify-center">
                      ...
                      <Image
                        ...
                        onError={(e) => {
                          ...
                          if (parent) {
                            ...
                            parent.className = "h-12 w-full bg-white rounded-md p-2 flex items-center justify-center text-gray-600 text-xs font-medium";
                          }
                        }}
                      />
                    </div>
          ...
          {/* ACCOLADES Section */}
          <div>
            <h3 className="text-orange-400 font-bold text-lg mb-4">ACCOLADES</h3>
          ...
          {/* SUBSCRIBE Section */}
          <div>
            <h3 className="text-orange-400 font-bold text-lg mb-4">SUBSCRIBE</h3>
            <div className="bg-white p-4 rounded">
              {/* Logo */}
              ...
              <form onSubmit={handleSubscribe} className="space-y-3">
                ...
                <button
                  type="submit"
                  className="w-full bg-primary text-white py-2 px-4 rounded-full font-bold text-sm hover:bg-orange-600 transition-colors"
                >
                  SUBSCRIBE!
                </button>
              </form>
      ...
      <div className="bg-orange-400 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="#" className="text-white hover:text-[#2C2C2C] transition-colors">
